...
OPERATIONAL_EXCELLENCE_BEST_PRACTICES: Dict[str, BestPractice] = {
    # Extract all OPS practices from the main file
    # This will be populated by moving practices from well_architected_framework.py
}